...
struct LocalizationService {
    ...
    static let english: [L10nKey: String] = [
        ...
        .disableBuiltInWebToolsDetail: "When RAG is enabled, hide WebFetch/WebSearch from model-visible tools so web search goes through G9Claw RAG skills.",
        .discover: "Discover",
        ...
        .quickAdd: "Quick add:",
        .rag: "RAG",
        .ragDetail: "When on, G9Claw exports G9CLAW_RAG_* env vars so RAG skills can call these APIs.",
        .ragSectionDetail: "Local retriever and GLM web search APIs used by the bundled G9Claw RAG skills.",
        ...
        .gitURLHelp: "If a Git URL is provided, G9Claw creates the target folder first and clones into it.",
    ...
    static let chineseSimplified: [L10nKey: String] = [
        ...
        .disableBuiltInWebToolsDetail: "启用 RAG 后，从模型可见工具中隐藏 WebFetch/WebSearch，让网络搜索走 G9Claw RAG 技能。",
        .discover: "扫描",
        ...
        .quickAdd: "快速添加：",
        .rag: "RAG",
        .ragDetail: "启用后，G9Claw 会导出 G9CLAW_RAG_* 环境变量，供 RAG 技能调用这些 API。",
        .ragSectionDetail: "内置 G9Claw RAG 技能使用的本地检索器和 GLM Web Search API。",
        ...
        .description: "描述",
        .alphabetical: "按字母排序",
        .gitURLHelp: "如果提供 Git URL，G9Claw 会先创建目标文件夹并 clone 到其中。",
