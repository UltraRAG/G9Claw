...
struct LocalizationService {
    ...
    static let english: [L10nKey: String] = [
        ...
        .configSummaryHelp: "This file is the same portable config used by the main project. Raw YAML and form edits both persist to ~/.pilotdeck/config.yaml.",
    ...
    static let chineseSimplified: [L10nKey: String] = [
        ...
        .configSummaryHelp: "这里就是主项目同款可移植配置文件；Raw YAML 和表单修改都会持久化到 ~/.pilotdeck/config.yaml。",
        .configValid: "配置有效",
        .cost: "成本",
        .discover: "扫描",
