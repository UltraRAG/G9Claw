...
struct LocalizationService {
    ...
    static let english: [L10nKey: String] = [
        ...
        .permissionsManageDetail: "Share or back up your tool permissions as JSON.",
        ...
        .configSummaryHelp: "This file is the same portable config used by the web app. Raw YAML and form edits both persist to ~/.pilotdeck/pilotdeck.yaml.",
        ...
        .gitURLHelp: "If a Git URL is provided, PilotDeck creates the target folder first and clones into it.",
    ...
    static let chineseSimplified: [L10nKey: String] = [
        ...
        .permissions: "权限",
        .permissionsManageDetail: "以 JSON 共享或备份工具权限。",
        ...
        .configSummaryHelp: "这里就是网页版同款可移植配置文件；Raw YAML 和表单修改都会持久化到 ~/.pilotdeck/pilotdeck.yaml。",
        .configValid: "配置有效",
        .cost: "成本",
        .discover: "扫描",
        ...
        .description: "描述",
        .alphabetical: "按字母排序",
        .gitURLHelp: "如果提供 Git URL，PilotDeck 会先创建目标文件夹并 clone 到其中。",
