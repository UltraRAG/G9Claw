...
class RagScriptTests(unittest.TestCase):
    def setUp(self):
        ...
        self.env.start()
        os.environ["G9CLAW_RAG_ENABLED"] = "1"
    ...
    def test_local_search_success(self):
        with ServerFixture() as fixture:
            ...
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_BASE_URL"] = fixture.base_url
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_API_KEY"] = "secret"
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_MODEL_NAME"] = "retriever-v1"
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_DATABASE_URL"] = f"{fixture.base_url}/search"
    ...
    def test_web_search_success(self):
        with ServerFixture() as fixture:
            ...
            os.environ["G9CLAW_RAG_GLM_WEB_SEARCH_BASE_URL"] = fixture.base_url
    ...
    def test_default_top_k_comes_from_environment(self):
        with ServerFixture() as fixture:
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_BASE_URL"] = fixture.base_url
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_TOP_K"] = "11"
            local_result = local_knowledge_search.search_local_knowledge("local query")
            local_top_k = _Handler.last_request["body"]["top_k"]

            os.environ["G9CLAW_RAG_GLM_WEB_SEARCH_BASE_URL"] = f"{fixture.base_url}/api/paas/v4/web_search"
            os.environ["G9CLAW_RAG_GLM_WEB_SEARCH_TOP_K"] = "10"
    ...
    def test_zai_web_search_endpoint_success(self):
        with ServerFixture() as fixture:
            ...
            os.environ["G9CLAW_RAG_GLM_WEB_SEARCH_BASE_URL"] = f"{fixture.base_url}/api/paas/v4/web_search"
            os.environ["G9CLAW_RAG_GLM_WEB_SEARCH_API_KEY"] = "web-secret"
    ...
    def test_timeout_returns_json_error(self):
        ...
        with mock.patch("glm_web_search._request_json", side_effect=timeout):
            os.environ["G9CLAW_RAG_GLM_WEB_SEARCH_BASE_URL"] = "http://127.0.0.1:1"
    ...
    def test_invalid_json_returns_json_error(self):
        with mock.patch("local_knowledge_search._request_json", side_effect=json.JSONDecodeError("bad", "x", 0)):
            os.environ["G9CLAW_RAG_LOCAL_KNOWLEDGE_BASE_URL"] = "http://127.0.0.1:1"
            result = local_knowledge_search.search_local_knowledge("query")
        self.assertFalse(result["ok"])
