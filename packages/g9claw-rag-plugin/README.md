...
The G9Claw app loads this bundled plugin from its app resources. For direct CLI
testing, pass it explicitly:

```bash
bun run src/entrypoints/cli.tsx --plugin-dir ../packages/g9claw-rag-plugin
```
